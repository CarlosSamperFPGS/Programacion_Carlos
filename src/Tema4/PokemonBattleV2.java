...
public class PokemonBattleV2 {
    ...
    private static void showTitleAndRules() {
        System.out.println("****************************************");
        System.out.println("*****************************************");
        System.out.println("Bienvenido a Pokemon Battle Simulator V2 (Mejorado)");
        System.out.println("*****************************************");
        System.out.println("****************************************");
    ...
    private static Pokemon selectPokemon(int playerNum) {
        ...
        switch (choice) {
            ...
            case "Pidgey":
                return new Pokemon("Pidgey", "Normal", "Volador", 40, 45, 40, 35, 35, 56);
            default:
    ...
    private static Pokemon createCustomPokemon(int playerNum) {
        ...
        // Para compatibilidad con el código anterior, asignamos movimientos básicos
    ...
    private static void battleLoop(Pokemon p1, Pokemon p2, boolean isP2AI) {
        // Asignar movimientos por defecto si no tienen (para los pokemon predefinidos en selectPokemon)
    ...
    private static void performAttack(Pokemon attacker, Pokemon defender, Move move) {
        ...
        double effectiveness = getEffectiveness(move.getType(), defender.getType1()); // Simplified to Type1 check for V2
